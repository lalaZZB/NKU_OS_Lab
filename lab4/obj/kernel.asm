...
ffffffffc0200048:	e406                	sd	ra,8(sp)
    memset(edata, 0, end - edata);
ffffffffc020004a:	627040ef          	jal	ra,ffffffffc0204e70 <memset>
...
ffffffffc02000ac:	e4050513          	addi	a0,a0,-448 # ffffffffc0204ee8 <etext+0x2a>
...
ffffffffc0200172:	c602                	sw	zero,12(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc0200174:	0ff040ef          	jal	ra,ffffffffc0204a72 <vprintfmt>
    return cnt;
}
...
ffffffffc02001a8:	c202                	sw	zero,4(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02001aa:	0c9040ef          	jal	ra,ffffffffc0204a72 <vprintfmt>
    cnt = vcprintf(fmt, ap);
    va_end(ap);
    return cnt;
}
...
ffffffffc02001ce:	d2650513          	addi	a0,a0,-730 # ffffffffc0204ef0 <etext+0x32>
void print_kerninfo(void) {
...
ffffffffc02001e4:	d3050513          	addi	a0,a0,-720 # ffffffffc0204f10 <etext+0x52>
ffffffffc02001e8:	f99ff0ef          	jal	ra,ffffffffc0200180 <cprintf>
    cprintf("  etext  0x%08x (virtual)\n", etext);
ffffffffc02001ec:	00005597          	auipc	a1,0x5
ffffffffc02001f0:	cd258593          	addi	a1,a1,-814 # ffffffffc0204ebe <etext>
ffffffffc02001f4:	00005517          	auipc	a0,0x5
ffffffffc02001f8:	d3c50513          	addi	a0,a0,-708 # ffffffffc0204f30 <etext+0x72>
...
ffffffffc020020c:	d4850513          	addi	a0,a0,-696 # ffffffffc0204f50 <etext+0x92>
...
ffffffffc0200220:	d5450513          	addi	a0,a0,-684 # ffffffffc0204f70 <etext+0xb2>
...
ffffffffc020024e:	d4650513          	addi	a0,a0,-698 # ffffffffc0204f90 <etext+0xd2>
}
...
ffffffffc020025c:	d6860613          	addi	a2,a2,-664 # ffffffffc0204fc0 <etext+0x102>
ffffffffc0200260:	04d00593          	li	a1,77
ffffffffc0200264:	00005517          	auipc	a0,0x5
ffffffffc0200268:	d7450513          	addi	a0,a0,-652 # ffffffffc0204fd8 <etext+0x11a>
void print_stackframe(void) {
...
ffffffffc0200278:	d7c60613          	addi	a2,a2,-644 # ffffffffc0204ff0 <etext+0x132>
ffffffffc020027c:	00005597          	auipc	a1,0x5
ffffffffc0200280:	d9458593          	addi	a1,a1,-620 # ffffffffc0205010 <etext+0x152>
ffffffffc0200284:	00005517          	auipc	a0,0x5
ffffffffc0200288:	d9450513          	addi	a0,a0,-620 # ffffffffc0205018 <etext+0x15a>
mon_help(int argc, char **argv, struct trapframe *tf) {
...
ffffffffc0200296:	d9660613          	addi	a2,a2,-618 # ffffffffc0205028 <etext+0x16a>
ffffffffc020029a:	00005597          	auipc	a1,0x5
ffffffffc020029e:	db658593          	addi	a1,a1,-586 # ffffffffc0205050 <etext+0x192>
ffffffffc02002a2:	00005517          	auipc	a0,0x5
ffffffffc02002a6:	d7650513          	addi	a0,a0,-650 # ffffffffc0205018 <etext+0x15a>
ffffffffc02002aa:	ed7ff0ef          	jal	ra,ffffffffc0200180 <cprintf>
ffffffffc02002ae:	00005617          	auipc	a2,0x5
ffffffffc02002b2:	db260613          	addi	a2,a2,-590 # ffffffffc0205060 <etext+0x1a2>
ffffffffc02002b6:	00005597          	auipc	a1,0x5
ffffffffc02002ba:	dca58593          	addi	a1,a1,-566 # ffffffffc0205080 <etext+0x1c2>
ffffffffc02002be:	00005517          	auipc	a0,0x5
ffffffffc02002c2:	d5a50513          	addi	a0,a0,-678 # ffffffffc0205018 <etext+0x15a>
...
ffffffffc02002fc:	d9850513          	addi	a0,a0,-616 # ffffffffc0205090 <etext+0x1d2>
kmonitor(struct trapframe *tf) {
...
ffffffffc020031e:	d9e50513          	addi	a0,a0,-610 # ffffffffc02050b8 <etext+0x1fa>
...
ffffffffc0200348:	d9c90913          	addi	s2,s2,-612 # ffffffffc02050e0 <etext+0x222>
        while (*buf != '\0' && strchr(WHITESPACE, *buf) != NULL) {
ffffffffc020034c:	00005497          	auipc	s1,0x5
ffffffffc0200350:	d9c48493          	addi	s1,s1,-612 # ffffffffc02050e8 <etext+0x22a>
        if (argc == MAXARGS - 1) {
ffffffffc0200354:	49bd                	li	s3,15
            cprintf("Too many arguments (max %d).\n", MAXARGS);
ffffffffc0200356:	00005b17          	auipc	s6,0x5
ffffffffc020035a:	d9ab0b13          	addi	s6,s6,-614 # ffffffffc02050f0 <etext+0x232>
        argv[argc ++] = buf;
ffffffffc020035e:	00005a17          	auipc	s4,0x5
ffffffffc0200362:	cb2a0a13          	addi	s4,s4,-846 # ffffffffc0205010 <etext+0x152>
    for (i = 0; i < NCOMMANDS; i ++) {
...
ffffffffc020038c:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc020038e:	2af040ef          	jal	ra,ffffffffc0204e3c <strcmp>
...
ffffffffc02003a0:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02003a2:	29b040ef          	jal	ra,ffffffffc0204e3c <strcmp>
...
ffffffffc02003e0:	27b040ef          	jal	ra,ffffffffc0204e5a <strchr>
...
ffffffffc020041e:	23d040ef          	jal	ra,ffffffffc0204e5a <strchr>
...
ffffffffc020043c:	cd850513          	addi	a0,a0,-808 # ffffffffc0205110 <etext+0x252>
...
ffffffffc020058a:	e406                	sd	ra,8(sp)
    memcpy(dst, &ide[iobase], nsecs * SECTSIZE);
ffffffffc020058c:	0f7040ef          	jal	ra,ffffffffc0204e82 <memcpy>
    return 0;
}
...
ffffffffc02005ae:	e406                	sd	ra,8(sp)
    memcpy(&ide[iobase], src, nsecs * SECTSIZE);
ffffffffc02005b0:	0d3040ef          	jal	ra,ffffffffc0204e82 <memcpy>
    return 0;
}
...
ffffffffc0200c2e:	37663603          	ld	a2,886(a2) # ffffffffc0206fa0 <nbase>
...
ffffffffc02016f4:	8b06b683          	ld	a3,-1872(a3) # ffffffffc0206fa0 <nbase>
...
ffffffffc0201968:	63c53503          	ld	a0,1596(a0) # ffffffffc0206fa0 <nbase>
...
ffffffffc0201bbe:	2b2030ef          	jal	ra,ffffffffc0204e70 <memset>
    return page - pages + nbase;
...
ffffffffc0201c50:	220030ef          	jal	ra,ffffffffc0204e70 <memset>
    return page - pages + nbase;
...
ffffffffc0202352:	2d9020ef          	jal	ra,ffffffffc0204e2a <strcpy>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc0202356:	10040593          	addi	a1,s0,256
ffffffffc020235a:	10000513          	li	a0,256
ffffffffc020235e:	2df020ef          	jal	ra,ffffffffc0204e3c <strcmp>
...
ffffffffc0202390:	10068023          	sb	zero,256(a3)
    assert(strlen((const char *)0x100) == 0);
ffffffffc0202394:	261020ef          	jal	ra,ffffffffc0204df4 <strlen>
...
ffffffffc0202e2c:	17860613          	addi	a2,a2,376 # ffffffffc0206fa0 <nbase>
...
ffffffffc0203cc2:	2e2a3a03          	ld	s4,738(s4) # ffffffffc0206fa0 <nbase>
...
ffffffffc0204080:	a8450513          	addi	a0,a0,-1404 # ffffffffc0206b00 <default_pmm_manager+0xef0>
...
ffffffffc0204092:	a2250513          	addi	a0,a0,-1502 # ffffffffc0206ab0 <default_pmm_manager+0xea0>
...
ffffffffc02040a2:	a8a50513          	addi	a0,a0,-1398 # ffffffffc0206b28 <default_pmm_manager+0xf18>
...
ffffffffc02040b2:	a3250513          	addi	a0,a0,-1486 # ffffffffc0206ae0 <default_pmm_manager+0xed0>
...
ffffffffc02040e4:	a7060613          	addi	a2,a2,-1424 # ffffffffc0206b50 <default_pmm_manager+0xf40>
ffffffffc02040e8:	45b5                	li	a1,13
ffffffffc02040ea:	00003517          	auipc	a0,0x3
ffffffffc02040ee:	a8650513          	addi	a0,a0,-1402 # ffffffffc0206b70 <default_pmm_manager+0xf60>
...
ffffffffc0204158:	a3460613          	addi	a2,a2,-1484 # ffffffffc0206b88 <default_pmm_manager+0xf78>
ffffffffc020415c:	45d1                	li	a1,20
ffffffffc020415e:	00003517          	auipc	a0,0x3
ffffffffc0204162:	a1250513          	addi	a0,a0,-1518 # ffffffffc0206b70 <default_pmm_manager+0xf60>
...
ffffffffc0204174:	ad860613          	addi	a2,a2,-1320 # ffffffffc0205c48 <default_pmm_manager+0x38>
ffffffffc0204178:	00002517          	auipc	a0,0x2
ffffffffc020417c:	af850513          	addi	a0,a0,-1288 # ffffffffc0205c70 <default_pmm_manager+0x60>
...
ffffffffc02041e6:	9a660613          	addi	a2,a2,-1626 # ffffffffc0206b88 <default_pmm_manager+0xf78>
ffffffffc02041ea:	45e5                	li	a1,25
ffffffffc02041ec:	00003517          	auipc	a0,0x3
ffffffffc02041f0:	98450513          	addi	a0,a0,-1660 # ffffffffc0206b70 <default_pmm_manager+0xf60>
...
ffffffffc0204202:	a4a60613          	addi	a2,a2,-1462 # ffffffffc0205c48 <default_pmm_manager+0x38>
ffffffffc0204206:	00002517          	auipc	a0,0x2
ffffffffc020420a:	a6a50513          	addi	a0,a0,-1430 # ffffffffc0205c70 <default_pmm_manager+0x60>
...
ffffffffc0204250:	421000ef          	jal	ra,ffffffffc0204e70 <memset>
...
ffffffffc020426e:	403000ef          	jal	ra,ffffffffc0204e70 <memset>
...
ffffffffc02042d8:	8fc50513          	addi	a0,a0,-1796 # ffffffffc0206bd0 <default_pmm_manager+0xfc0>
ffffffffc02042dc:	ea5fb0ef          	jal	ra,ffffffffc0200180 <cprintf>
    cprintf("To U: \"en.., Bye, Bye. :)\"\n");
ffffffffc02042e0:	00003517          	auipc	a0,0x3
ffffffffc02042e4:	90050513          	addi	a0,a0,-1792 # ffffffffc0206be0 <default_pmm_manager+0xfd0>
...
ffffffffc02043c2:	be253503          	ld	a0,-1054(a0) # ffffffffc0206fa0 <nbase>
...
ffffffffc020448a:	566000ef          	jal	ra,ffffffffc02049f0 <hash32>
...
ffffffffc02044d0:	45a000ef          	jal	ra,ffffffffc020492a <wakeup_proc>
...
ffffffffc02045b6:	64e68693          	addi	a3,a3,1614 # ffffffffc0206c00 <default_pmm_manager+0xff0>
ffffffffc02045ba:	00001617          	auipc	a2,0x1
ffffffffc02045be:	2a660613          	addi	a2,a2,678 # ffffffffc0205860 <commands+0x738>
ffffffffc02045c2:	10600593          	li	a1,262
ffffffffc02045c6:	00002517          	auipc	a0,0x2
ffffffffc02045ca:	65250513          	addi	a0,a0,1618 # ffffffffc0206c18 <default_pmm_manager+0x1008>
ffffffffc02045ce:	e79fb0ef          	jal	ra,ffffffffc0200446 <__panic>
ffffffffc02045d2:	00001617          	auipc	a2,0x1
ffffffffc02045d6:	67660613          	addi	a2,a2,1654 # ffffffffc0205c48 <default_pmm_manager+0x38>
ffffffffc02045da:	06900593          	li	a1,105
ffffffffc02045de:	00001517          	auipc	a0,0x1
ffffffffc02045e2:	69250513          	addi	a0,a0,1682 # ffffffffc0205c70 <default_pmm_manager+0x60>
...
ffffffffc0204600:	fe06                	sd	ra,312(sp)
    memset(&tf, 0, sizeof(struct trapframe));
ffffffffc0204602:	06f000ef          	jal	ra,ffffffffc0204e70 <memset>
...
ffffffffc0204640:	5f460613          	addi	a2,a2,1524 # ffffffffc0206c30 <default_pmm_manager+0x1020>
ffffffffc0204644:	16700593          	li	a1,359
ffffffffc0204648:	00002517          	auipc	a0,0x2
ffffffffc020464c:	5d050513          	addi	a0,a0,1488 # ffffffffc0206c18 <default_pmm_manager+0x1008>
do_exit(int error_code) {
...
ffffffffc02046ac:	842a                	mv	s0,a0
    memset(context_mem, 0, sizeof(struct context));
ffffffffc02046ae:	7c2000ef          	jal	ra,ffffffffc0204e70 <memset>
...
ffffffffc02046c0:	7da000ef          	jal	ra,ffffffffc0204e9a <memcmp>
...
ffffffffc02046d0:	842a                	mv	s0,a0
    memset(proc_name_mem, 0, PROC_NAME_LEN);
ffffffffc02046d2:	79e000ef          	jal	ra,ffffffffc0204e70 <memset>
...
ffffffffc02046e2:	7b8000ef          	jal	ra,ffffffffc0204e9a <memcmp>
...
ffffffffc0204714:	75c000ef          	jal	ra,ffffffffc0204e70 <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc0204718:	463d                	li	a2,15
ffffffffc020471a:	00002597          	auipc	a1,0x2
ffffffffc020471e:	55e58593          	addi	a1,a1,1374 # ffffffffc0206c78 <default_pmm_manager+0x1068>
ffffffffc0204722:	8522                	mv	a0,s0
ffffffffc0204724:	75e000ef          	jal	ra,ffffffffc0204e82 <memcpy>
...
ffffffffc020473e:	54658593          	addi	a1,a1,1350 # ffffffffc0206c80 <default_pmm_manager+0x1070>
...
ffffffffc020476e:	282000ef          	jal	ra,ffffffffc02049f0 <hash32>
...
ffffffffc02047a2:	e01c                	sd	a5,0(s0)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc02047a4:	6cc000ef          	jal	ra,ffffffffc0204e70 <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc02047a8:	463d                	li	a2,15
ffffffffc02047aa:	00002597          	auipc	a1,0x2
ffffffffc02047ae:	50658593          	addi	a1,a1,1286 # ffffffffc0206cb0 <default_pmm_manager+0x10a0>
ffffffffc02047b2:	8526                	mv	a0,s1
ffffffffc02047b4:	6ce000ef          	jal	ra,ffffffffc0204e82 <memcpy>
...
ffffffffc0204820:	44450513          	addi	a0,a0,1092 # ffffffffc0206c60 <default_pmm_manager+0x1050>
...
ffffffffc0204838:	41460613          	addi	a2,a2,1044 # ffffffffc0206c48 <default_pmm_manager+0x1038>
ffffffffc020483c:	17f00593          	li	a1,383
ffffffffc0204840:	00002517          	auipc	a0,0x2
ffffffffc0204844:	3d850513          	addi	a0,a0,984 # ffffffffc0206c18 <default_pmm_manager+0x1008>
ffffffffc0204848:	bfffb0ef          	jal	ra,ffffffffc0200446 <__panic>
        panic("create init_main failed.\n");
ffffffffc020484c:	00002617          	auipc	a2,0x2
ffffffffc0204850:	44460613          	addi	a2,a2,1092 # ffffffffc0206c90 <default_pmm_manager+0x1080>
ffffffffc0204854:	19f00593          	li	a1,415
ffffffffc0204858:	00002517          	auipc	a0,0x2
ffffffffc020485c:	3c050513          	addi	a0,a0,960 # ffffffffc0206c18 <default_pmm_manager+0x1008>
ffffffffc0204860:	be7fb0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc0204864:	00002697          	auipc	a3,0x2
ffffffffc0204868:	47c68693          	addi	a3,a3,1148 # ffffffffc0206ce0 <default_pmm_manager+0x10d0>
ffffffffc020486c:	00001617          	auipc	a2,0x1
ffffffffc0204870:	ff460613          	addi	a2,a2,-12 # ffffffffc0205860 <commands+0x738>
ffffffffc0204874:	1a600593          	li	a1,422
ffffffffc0204878:	00002517          	auipc	a0,0x2
ffffffffc020487c:	3a050513          	addi	a0,a0,928 # ffffffffc0206c18 <default_pmm_manager+0x1008>
ffffffffc0204880:	bc7fb0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(idleproc != NULL && idleproc->pid == 0);
ffffffffc0204884:	00002697          	auipc	a3,0x2
ffffffffc0204888:	43468693          	addi	a3,a3,1076 # ffffffffc0206cb8 <default_pmm_manager+0x10a8>
ffffffffc020488c:	00001617          	auipc	a2,0x1
ffffffffc0204890:	fd460613          	addi	a2,a2,-44 # ffffffffc0205860 <commands+0x738>
ffffffffc0204894:	1a500593          	li	a1,421
ffffffffc0204898:	00002517          	auipc	a0,0x2
ffffffffc020489c:	38050513          	addi	a0,a0,896 # ffffffffc0206c18 <default_pmm_manager+0x1008>
...
ffffffffc02048b8:	dff5                	beqz	a5,ffffffffc02048b4 <cpu_idle+0x10>
            schedule();
ffffffffc02048ba:	0a2000ef          	jal	ra,ffffffffc020495c <schedule>
...
ffffffffc0204940:	3cc68693          	addi	a3,a3,972 # ffffffffc0206d08 <default_pmm_manager+0x10f8>
ffffffffc0204944:	00001617          	auipc	a2,0x1
ffffffffc0204948:	f1c60613          	addi	a2,a2,-228 # ffffffffc0205860 <commands+0x738>
ffffffffc020494c:	45a5                	li	a1,9
ffffffffc020494e:	00002517          	auipc	a0,0x2
ffffffffc0204952:	3fa50513          	addi	a0,a0,1018 # ffffffffc0206d48 <default_pmm_manager+0x1138>
wakeup_proc(struct proc_struct *proc) {
ffffffffc0204956:	e406                	sd	ra,8(sp)
    assert(proc->state != PROC_ZOMBIE && proc->state != PROC_RUNNABLE);
ffffffffc0204958:	aeffb0ef          	jal	ra,ffffffffc0200446 <__panic>
...
ffffffffc02049b4:	00a88463          	beq	a7,a0,ffffffffc02049bc <schedule+0x60>
            proc_run(next);
ffffffffc02049b8:	945ff0ef          	jal	ra,ffffffffc02042fc <proc_run>
    if (flag) {
...
ffffffffc02049d6:	0141                	addi	sp,sp,16
        intr_enable();
ffffffffc02049d8:	be5fb06f          	j	ffffffffc02005bc <intr_enable>
        last = (current == idleproc) ? &proc_list : &(current->list_link);
...
ffffffffc02049e6:	b76d                	j	ffffffffc0204990 <schedule+0x34>
        intr_disable();
ffffffffc02049e8:	bdbfb0ef          	jal	ra,ffffffffc02005c2 <intr_disable>
        return 1;
ffffffffc02049ec:	4405                	li	s0,1
ffffffffc02049ee:	bfbd                	j	ffffffffc020496c <schedule+0x10>

ffffffffc02049f0 <hash32>:
 *
...
ffffffffc02049f0:	9e3707b7          	lui	a5,0x9e370
ffffffffc02049f4:	2785                	addiw	a5,a5,1
ffffffffc02049f6:	02a7853b          	mulw	a0,a5,a0
    return (hash >> (32 - bits));
ffffffffc02049fa:	02000793          	li	a5,32
ffffffffc02049fe:	9f8d                	subw	a5,a5,a1
}
ffffffffc0204a00:	00f5553b          	srlw	a0,a0,a5
...
ffffffffc0204a28:	2a01                	sext.w	s4,s4
    if (num >= base) {
ffffffffc0204a2a:	03067e63          	bgeu	a2,a6,ffffffffc0204a66 <printnum+0x60>
...
ffffffffc0204a44:	32078793          	addi	a5,a5,800 # ffffffffc0206d60 <default_pmm_manager+0x1150>
...
ffffffffc0204a78:	ecce                	sd	s3,88(sp)
ffffffffc0204a7a:	e8d2                	sd	s4,80(sp)
ffffffffc0204a7c:	e4d6                	sd	s5,72(sp)
ffffffffc0204a7e:	e0da                	sd	s6,64(sp)
ffffffffc0204a80:	fc5e                	sd	s7,56(sp)
ffffffffc0204a82:	f06a                	sd	s10,32(sp)
ffffffffc0204a84:	fc86                	sd	ra,120(sp)
ffffffffc0204a86:	f8a2                	sd	s0,112(sp)
ffffffffc0204a88:	f862                	sd	s8,48(sp)
...
ffffffffc0204a94:	8a36                	mv	s4,a3
    register int ch, err;
...
ffffffffc0204a96:	02500993          	li	s3,37
            putch(ch, putdat);
        }
...
ffffffffc0204a9c:	00002a97          	auipc	s5,0x2
ffffffffc0204aa0:	2f0a8a93          	addi	s5,s5,752 # ffffffffc0206d8c <default_pmm_manager+0x117c>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
...
ffffffffc0204aa4:	00002b97          	auipc	s7,0x2
ffffffffc0204aa8:	4c4b8b93          	addi	s7,s7,1220 # ffffffffc0206f68 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0204aac:	000d4503          	lbu	a0,0(s10)
ffffffffc0204ab0:	001d0413          	addi	s0,s10,1
ffffffffc0204ab4:	01350a63          	beq	a0,s3,ffffffffc0204ac8 <vprintfmt+0x56>
            if (ch == '\0') {
ffffffffc0204ab8:	c121                	beqz	a0,ffffffffc0204af8 <vprintfmt+0x86>
            putch(ch, putdat);
ffffffffc0204aba:	85a6                	mv	a1,s1
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0204abc:	0405                	addi	s0,s0,1
            putch(ch, putdat);
ffffffffc0204abe:	9902                	jalr	s2
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0204ac0:	fff44503          	lbu	a0,-1(s0)
ffffffffc0204ac4:	ff351ae3          	bne	a0,s3,ffffffffc0204ab8 <vprintfmt+0x46>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204ac8:	00044603          	lbu	a2,0(s0)
        char padc = ' ';
ffffffffc0204acc:	02000793          	li	a5,32
        lflag = altflag = 0;
ffffffffc0204ad0:	4c81                	li	s9,0
ffffffffc0204ad2:	4881                	li	a7,0
        width = precision = -1;
ffffffffc0204ad4:	5c7d                	li	s8,-1
ffffffffc0204ad6:	5dfd                	li	s11,-1
ffffffffc0204ad8:	05500513          	li	a0,85
                if (ch < '0' || ch > '9') {
ffffffffc0204adc:	4825                	li	a6,9
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204ade:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0204ae2:	0ff5f593          	zext.b	a1,a1
ffffffffc0204ae6:	00140d13          	addi	s10,s0,1
ffffffffc0204aea:	04b56263          	bltu	a0,a1,ffffffffc0204b2e <vprintfmt+0xbc>
ffffffffc0204aee:	058a                	slli	a1,a1,0x2
ffffffffc0204af0:	95d6                	add	a1,a1,s5
ffffffffc0204af2:	4194                	lw	a3,0(a1)
ffffffffc0204af4:	96d6                	add	a3,a3,s5
ffffffffc0204af6:	8682                	jr	a3
            for (fmt --; fmt[-1] != '%'; fmt --)
                /* do nothing */;
            break;
        }
...
ffffffffc0204af8:	70e6                	ld	ra,120(sp)
ffffffffc0204afa:	7446                	ld	s0,112(sp)
ffffffffc0204afc:	74a6                	ld	s1,104(sp)
ffffffffc0204afe:	7906                	ld	s2,96(sp)
ffffffffc0204b00:	69e6                	ld	s3,88(sp)
ffffffffc0204b02:	6a46                	ld	s4,80(sp)
ffffffffc0204b04:	6aa6                	ld	s5,72(sp)
ffffffffc0204b06:	6b06                	ld	s6,64(sp)
ffffffffc0204b08:	7be2                	ld	s7,56(sp)
ffffffffc0204b0a:	7c42                	ld	s8,48(sp)
ffffffffc0204b0c:	7ca2                	ld	s9,40(sp)
ffffffffc0204b0e:	7d02                	ld	s10,32(sp)
ffffffffc0204b10:	6de2                	ld	s11,24(sp)
ffffffffc0204b12:	6109                	addi	sp,sp,128
ffffffffc0204b14:	8082                	ret
            padc = '0';
ffffffffc0204b16:	87b2                	mv	a5,a2
            goto reswitch;
ffffffffc0204b18:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204b1c:	846a                	mv	s0,s10
ffffffffc0204b1e:	00140d13          	addi	s10,s0,1
ffffffffc0204b22:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0204b26:	0ff5f593          	zext.b	a1,a1
ffffffffc0204b2a:	fcb572e3          	bgeu	a0,a1,ffffffffc0204aee <vprintfmt+0x7c>
            putch('%', putdat);
ffffffffc0204b2e:	85a6                	mv	a1,s1
ffffffffc0204b30:	02500513          	li	a0,37
ffffffffc0204b34:	9902                	jalr	s2
            for (fmt --; fmt[-1] != '%'; fmt --)
ffffffffc0204b36:	fff44783          	lbu	a5,-1(s0)
ffffffffc0204b3a:	8d22                	mv	s10,s0
ffffffffc0204b3c:	f73788e3          	beq	a5,s3,ffffffffc0204aac <vprintfmt+0x3a>
ffffffffc0204b40:	ffed4783          	lbu	a5,-2(s10)
ffffffffc0204b44:	1d7d                	addi	s10,s10,-1
ffffffffc0204b46:	ff379de3          	bne	a5,s3,ffffffffc0204b40 <vprintfmt+0xce>
ffffffffc0204b4a:	b78d                	j	ffffffffc0204aac <vprintfmt+0x3a>
                precision = precision * 10 + ch - '0';
ffffffffc0204b4c:	fd060c1b          	addiw	s8,a2,-48
                ch = *fmt;
ffffffffc0204b50:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204b54:	846a                	mv	s0,s10
                if (ch < '0' || ch > '9') {
ffffffffc0204b56:	fd06069b          	addiw	a3,a2,-48
                ch = *fmt;
ffffffffc0204b5a:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc0204b5e:	02d86463          	bltu	a6,a3,ffffffffc0204b86 <vprintfmt+0x114>
                ch = *fmt;
ffffffffc0204b62:	00144603          	lbu	a2,1(s0)
                precision = precision * 10 + ch - '0';
ffffffffc0204b66:	002c169b          	slliw	a3,s8,0x2
ffffffffc0204b6a:	0186873b          	addw	a4,a3,s8
ffffffffc0204b6e:	0017171b          	slliw	a4,a4,0x1
ffffffffc0204b72:	9f2d                	addw	a4,a4,a1
                if (ch < '0' || ch > '9') {
ffffffffc0204b74:	fd06069b          	addiw	a3,a2,-48
            for (precision = 0; ; ++ fmt) {
ffffffffc0204b78:	0405                	addi	s0,s0,1
                precision = precision * 10 + ch - '0';
ffffffffc0204b7a:	fd070c1b          	addiw	s8,a4,-48
                ch = *fmt;
ffffffffc0204b7e:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc0204b82:	fed870e3          	bgeu	a6,a3,ffffffffc0204b62 <vprintfmt+0xf0>
            if (width < 0)
ffffffffc0204b86:	f40ddce3          	bgez	s11,ffffffffc0204ade <vprintfmt+0x6c>
                width = precision, precision = -1;
ffffffffc0204b8a:	8de2                	mv	s11,s8
ffffffffc0204b8c:	5c7d                	li	s8,-1
ffffffffc0204b8e:	bf81                	j	ffffffffc0204ade <vprintfmt+0x6c>
            if (width < 0)
ffffffffc0204b90:	fffdc693          	not	a3,s11
ffffffffc0204b94:	96fd                	srai	a3,a3,0x3f
ffffffffc0204b96:	00ddfdb3          	and	s11,s11,a3
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204b9a:	00144603          	lbu	a2,1(s0)
ffffffffc0204b9e:	2d81                	sext.w	s11,s11
ffffffffc0204ba0:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204ba2:	bf35                	j	ffffffffc0204ade <vprintfmt+0x6c>
            precision = va_arg(ap, int);
ffffffffc0204ba4:	000a2c03          	lw	s8,0(s4)
        switch (ch = *(unsigned char *)fmt ++) {
...
ffffffffc0204bb0:	bfd9                	j	ffffffffc0204b86 <vprintfmt+0x114>
    if (lflag >= 2) {
ffffffffc0204bb2:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204bb4:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0204bb8:	01174463          	blt	a4,a7,ffffffffc0204bc0 <vprintfmt+0x14e>
    else if (lflag) {
ffffffffc0204bbc:	1a088e63          	beqz	a7,ffffffffc0204d78 <vprintfmt+0x306>
        return va_arg(*ap, unsigned long);
ffffffffc0204bc0:	000a3603          	ld	a2,0(s4)
ffffffffc0204bc4:	46c1                	li	a3,16
ffffffffc0204bc6:	8a2e                	mv	s4,a1
            printnum(putch, putdat, num, base, width, padc);
ffffffffc0204bc8:	2781                	sext.w	a5,a5
ffffffffc0204bca:	876e                	mv	a4,s11
ffffffffc0204bcc:	85a6                	mv	a1,s1
ffffffffc0204bce:	854a                	mv	a0,s2
ffffffffc0204bd0:	e37ff0ef          	jal	ra,ffffffffc0204a06 <printnum>
            break;
ffffffffc0204bd4:	bde1                	j	ffffffffc0204aac <vprintfmt+0x3a>
            putch(va_arg(ap, int), putdat);
ffffffffc0204bd6:	000a2503          	lw	a0,0(s4)
ffffffffc0204bda:	85a6                	mv	a1,s1
ffffffffc0204bdc:	0a21                	addi	s4,s4,8
ffffffffc0204bde:	9902                	jalr	s2
            break;
ffffffffc0204be0:	b5f1                	j	ffffffffc0204aac <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0204be2:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204be4:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0204be8:	01174463          	blt	a4,a7,ffffffffc0204bf0 <vprintfmt+0x17e>
    else if (lflag) {
ffffffffc0204bec:	18088163          	beqz	a7,ffffffffc0204d6e <vprintfmt+0x2fc>
        return va_arg(*ap, unsigned long);
ffffffffc0204bf0:	000a3603          	ld	a2,0(s4)
ffffffffc0204bf4:	46a9                	li	a3,10
ffffffffc0204bf6:	8a2e                	mv	s4,a1
ffffffffc0204bf8:	bfc1                	j	ffffffffc0204bc8 <vprintfmt+0x156>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204bfa:	00144603          	lbu	a2,1(s0)
            altflag = 1;
ffffffffc0204bfe:	4c85                	li	s9,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c00:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204c02:	bdf1                	j	ffffffffc0204ade <vprintfmt+0x6c>
            putch(ch, putdat);
ffffffffc0204c04:	85a6                	mv	a1,s1
ffffffffc0204c06:	02500513          	li	a0,37
ffffffffc0204c0a:	9902                	jalr	s2
            break;
ffffffffc0204c0c:	b545                	j	ffffffffc0204aac <vprintfmt+0x3a>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c0e:	00144603          	lbu	a2,1(s0)
            lflag ++;
ffffffffc0204c12:	2885                	addiw	a7,a7,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c14:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204c16:	b5e1                	j	ffffffffc0204ade <vprintfmt+0x6c>
    if (lflag >= 2) {
ffffffffc0204c18:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204c1a:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0204c1e:	01174463          	blt	a4,a7,ffffffffc0204c26 <vprintfmt+0x1b4>
    else if (lflag) {
ffffffffc0204c22:	14088163          	beqz	a7,ffffffffc0204d64 <vprintfmt+0x2f2>
        return va_arg(*ap, unsigned long);
ffffffffc0204c26:	000a3603          	ld	a2,0(s4)
ffffffffc0204c2a:	46a1                	li	a3,8
ffffffffc0204c2c:	8a2e                	mv	s4,a1
ffffffffc0204c2e:	bf69                	j	ffffffffc0204bc8 <vprintfmt+0x156>
            putch('0', putdat);
ffffffffc0204c30:	03000513          	li	a0,48
ffffffffc0204c34:	85a6                	mv	a1,s1
ffffffffc0204c36:	e03e                	sd	a5,0(sp)
ffffffffc0204c38:	9902                	jalr	s2
            putch('x', putdat);
ffffffffc0204c3a:	85a6                	mv	a1,s1
ffffffffc0204c3c:	07800513          	li	a0,120
ffffffffc0204c40:	9902                	jalr	s2
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc0204c42:	0a21                	addi	s4,s4,8
            goto number;
ffffffffc0204c44:	6782                	ld	a5,0(sp)
ffffffffc0204c46:	46c1                	li	a3,16
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc0204c48:	ff8a3603          	ld	a2,-8(s4)
            goto number;
ffffffffc0204c4c:	bfb5                	j	ffffffffc0204bc8 <vprintfmt+0x156>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0204c4e:	000a3403          	ld	s0,0(s4)
ffffffffc0204c52:	008a0713          	addi	a4,s4,8
ffffffffc0204c56:	e03a                	sd	a4,0(sp)
ffffffffc0204c58:	14040263          	beqz	s0,ffffffffc0204d9c <vprintfmt+0x32a>
            if (width > 0 && padc != '-') {
ffffffffc0204c5c:	0fb05763          	blez	s11,ffffffffc0204d4a <vprintfmt+0x2d8>
ffffffffc0204c60:	02d00693          	li	a3,45
ffffffffc0204c64:	0cd79163          	bne	a5,a3,ffffffffc0204d26 <vprintfmt+0x2b4>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204c68:	00044783          	lbu	a5,0(s0)
ffffffffc0204c6c:	0007851b          	sext.w	a0,a5
ffffffffc0204c70:	cf85                	beqz	a5,ffffffffc0204ca8 <vprintfmt+0x236>
ffffffffc0204c72:	00140a13          	addi	s4,s0,1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204c76:	05e00413          	li	s0,94
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204c7a:	000c4563          	bltz	s8,ffffffffc0204c84 <vprintfmt+0x212>
ffffffffc0204c7e:	3c7d                	addiw	s8,s8,-1
ffffffffc0204c80:	036c0263          	beq	s8,s6,ffffffffc0204ca4 <vprintfmt+0x232>
                    putch('?', putdat);
ffffffffc0204c84:	85a6                	mv	a1,s1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204c86:	0e0c8e63          	beqz	s9,ffffffffc0204d82 <vprintfmt+0x310>
ffffffffc0204c8a:	3781                	addiw	a5,a5,-32
ffffffffc0204c8c:	0ef47b63          	bgeu	s0,a5,ffffffffc0204d82 <vprintfmt+0x310>
                    putch('?', putdat);
ffffffffc0204c90:	03f00513          	li	a0,63
ffffffffc0204c94:	9902                	jalr	s2
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204c96:	000a4783          	lbu	a5,0(s4)
ffffffffc0204c9a:	3dfd                	addiw	s11,s11,-1
ffffffffc0204c9c:	0a05                	addi	s4,s4,1
ffffffffc0204c9e:	0007851b          	sext.w	a0,a5
ffffffffc0204ca2:	ffe1                	bnez	a5,ffffffffc0204c7a <vprintfmt+0x208>
            for (; width > 0; width --) {
ffffffffc0204ca4:	01b05963          	blez	s11,ffffffffc0204cb6 <vprintfmt+0x244>
...
ffffffffc0204cb0:	9902                	jalr	s2
            for (; width > 0; width --) {
ffffffffc0204cb2:	fe0d9be3          	bnez	s11,ffffffffc0204ca8 <vprintfmt+0x236>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0204cb6:	6a02                	ld	s4,0(sp)
ffffffffc0204cb8:	bbd5                	j	ffffffffc0204aac <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0204cba:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204cbc:	008a0c93          	addi	s9,s4,8
    if (lflag >= 2) {
ffffffffc0204cc0:	01174463          	blt	a4,a7,ffffffffc0204cc8 <vprintfmt+0x256>
    else if (lflag) {
ffffffffc0204cc4:	08088d63          	beqz	a7,ffffffffc0204d5e <vprintfmt+0x2ec>
        return va_arg(*ap, long);
ffffffffc0204cc8:	000a3403          	ld	s0,0(s4)
            if ((long long)num < 0) {
ffffffffc0204ccc:	0a044d63          	bltz	s0,ffffffffc0204d86 <vprintfmt+0x314>
            num = getint(&ap, lflag);
ffffffffc0204cd0:	8622                	mv	a2,s0
ffffffffc0204cd2:	8a66                	mv	s4,s9
ffffffffc0204cd4:	46a9                	li	a3,10
ffffffffc0204cd6:	bdcd                	j	ffffffffc0204bc8 <vprintfmt+0x156>
            err = va_arg(ap, int);
ffffffffc0204cd8:	000a2783          	lw	a5,0(s4)
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0204cdc:	4719                	li	a4,6
            err = va_arg(ap, int);
ffffffffc0204cde:	0a21                	addi	s4,s4,8
            if (err < 0) {
ffffffffc0204ce0:	41f7d69b          	sraiw	a3,a5,0x1f
ffffffffc0204ce4:	8fb5                	xor	a5,a5,a3
ffffffffc0204ce6:	40d786bb          	subw	a3,a5,a3
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0204cea:	02d74163          	blt	a4,a3,ffffffffc0204d0c <vprintfmt+0x29a>
ffffffffc0204cee:	00369793          	slli	a5,a3,0x3
ffffffffc0204cf2:	97de                	add	a5,a5,s7
ffffffffc0204cf4:	639c                	ld	a5,0(a5)
ffffffffc0204cf6:	cb99                	beqz	a5,ffffffffc0204d0c <vprintfmt+0x29a>
                printfmt(putch, putdat, "%s", p);
ffffffffc0204cf8:	86be                	mv	a3,a5
ffffffffc0204cfa:	00000617          	auipc	a2,0x0
ffffffffc0204cfe:	1ee60613          	addi	a2,a2,494 # ffffffffc0204ee8 <etext+0x2a>
ffffffffc0204d02:	85a6                	mv	a1,s1
ffffffffc0204d04:	854a                	mv	a0,s2
ffffffffc0204d06:	0ce000ef          	jal	ra,ffffffffc0204dd4 <printfmt>
ffffffffc0204d0a:	b34d                	j	ffffffffc0204aac <vprintfmt+0x3a>
                printfmt(putch, putdat, "error %d", err);
ffffffffc0204d0c:	00002617          	auipc	a2,0x2
ffffffffc0204d10:	07460613          	addi	a2,a2,116 # ffffffffc0206d80 <default_pmm_manager+0x1170>
ffffffffc0204d14:	85a6                	mv	a1,s1
ffffffffc0204d16:	854a                	mv	a0,s2
ffffffffc0204d18:	0bc000ef          	jal	ra,ffffffffc0204dd4 <printfmt>
ffffffffc0204d1c:	bb41                	j	ffffffffc0204aac <vprintfmt+0x3a>
                p = "(null)";
ffffffffc0204d1e:	00002417          	auipc	s0,0x2
ffffffffc0204d22:	05a40413          	addi	s0,s0,90 # ffffffffc0206d78 <default_pmm_manager+0x1168>
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204d26:	85e2                	mv	a1,s8
ffffffffc0204d28:	8522                	mv	a0,s0
ffffffffc0204d2a:	e43e                	sd	a5,8(sp)
ffffffffc0204d2c:	0e2000ef          	jal	ra,ffffffffc0204e0e <strnlen>
ffffffffc0204d30:	40ad8dbb          	subw	s11,s11,a0
ffffffffc0204d34:	01b05b63          	blez	s11,ffffffffc0204d4a <vprintfmt+0x2d8>
                    putch(padc, putdat);
ffffffffc0204d38:	67a2                	ld	a5,8(sp)
ffffffffc0204d3a:	00078a1b          	sext.w	s4,a5
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204d3e:	3dfd                	addiw	s11,s11,-1
                    putch(padc, putdat);
ffffffffc0204d40:	85a6                	mv	a1,s1
ffffffffc0204d42:	8552                	mv	a0,s4
ffffffffc0204d44:	9902                	jalr	s2
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204d46:	fe0d9ce3          	bnez	s11,ffffffffc0204d3e <vprintfmt+0x2cc>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204d4a:	00044783          	lbu	a5,0(s0)
ffffffffc0204d4e:	00140a13          	addi	s4,s0,1
ffffffffc0204d52:	0007851b          	sext.w	a0,a5
ffffffffc0204d56:	d3a5                	beqz	a5,ffffffffc0204cb6 <vprintfmt+0x244>
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204d58:	05e00413          	li	s0,94
ffffffffc0204d5c:	bf39                	j	ffffffffc0204c7a <vprintfmt+0x208>
        return va_arg(*ap, int);
ffffffffc0204d5e:	000a2403          	lw	s0,0(s4)
ffffffffc0204d62:	b7ad                	j	ffffffffc0204ccc <vprintfmt+0x25a>
        return va_arg(*ap, unsigned int);
ffffffffc0204d64:	000a6603          	lwu	a2,0(s4)
ffffffffc0204d68:	46a1                	li	a3,8
ffffffffc0204d6a:	8a2e                	mv	s4,a1
ffffffffc0204d6c:	bdb1                	j	ffffffffc0204bc8 <vprintfmt+0x156>
ffffffffc0204d6e:	000a6603          	lwu	a2,0(s4)
ffffffffc0204d72:	46a9                	li	a3,10
ffffffffc0204d74:	8a2e                	mv	s4,a1
ffffffffc0204d76:	bd89                	j	ffffffffc0204bc8 <vprintfmt+0x156>
ffffffffc0204d78:	000a6603          	lwu	a2,0(s4)
ffffffffc0204d7c:	46c1                	li	a3,16
ffffffffc0204d7e:	8a2e                	mv	s4,a1
ffffffffc0204d80:	b5a1                	j	ffffffffc0204bc8 <vprintfmt+0x156>
                    putch(ch, putdat);
ffffffffc0204d82:	9902                	jalr	s2
ffffffffc0204d84:	bf09                	j	ffffffffc0204c96 <vprintfmt+0x224>
                putch('-', putdat);
ffffffffc0204d86:	85a6                	mv	a1,s1
ffffffffc0204d88:	02d00513          	li	a0,45
ffffffffc0204d8c:	e03e                	sd	a5,0(sp)
ffffffffc0204d8e:	9902                	jalr	s2
                num = -(long long)num;
ffffffffc0204d90:	6782                	ld	a5,0(sp)
ffffffffc0204d92:	8a66                	mv	s4,s9
ffffffffc0204d94:	40800633          	neg	a2,s0
ffffffffc0204d98:	46a9                	li	a3,10
ffffffffc0204d9a:	b53d                	j	ffffffffc0204bc8 <vprintfmt+0x156>
            if (width > 0 && padc != '-') {
ffffffffc0204d9c:	03b05163          	blez	s11,ffffffffc0204dbe <vprintfmt+0x34c>
ffffffffc0204da0:	02d00693          	li	a3,45
ffffffffc0204da4:	f6d79de3          	bne	a5,a3,ffffffffc0204d1e <vprintfmt+0x2ac>
                p = "(null)";
ffffffffc0204da8:	00002417          	auipc	s0,0x2
ffffffffc0204dac:	fd040413          	addi	s0,s0,-48 # ffffffffc0206d78 <default_pmm_manager+0x1168>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204db0:	02800793          	li	a5,40
ffffffffc0204db4:	02800513          	li	a0,40
ffffffffc0204db8:	00140a13          	addi	s4,s0,1
ffffffffc0204dbc:	bd6d                	j	ffffffffc0204c76 <vprintfmt+0x204>
ffffffffc0204dbe:	00002a17          	auipc	s4,0x2
ffffffffc0204dc2:	fbba0a13          	addi	s4,s4,-69 # ffffffffc0206d79 <default_pmm_manager+0x1169>
ffffffffc0204dc6:	02800513          	li	a0,40
ffffffffc0204dca:	02800793          	li	a5,40
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204dce:	05e00413          	li	s0,94
ffffffffc0204dd2:	b565                	j	ffffffffc0204c7a <vprintfmt+0x208>

ffffffffc0204dd4 <printfmt>:
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0204dd4:	715d                	addi	sp,sp,-80
    va_start(ap, fmt);
ffffffffc0204dd6:	02810313          	addi	t1,sp,40
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0204dda:	f436                	sd	a3,40(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc0204ddc:	869a                	mv	a3,t1
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0204dde:	ec06                	sd	ra,24(sp)
ffffffffc0204de0:	f83a                	sd	a4,48(sp)
ffffffffc0204de2:	fc3e                	sd	a5,56(sp)
ffffffffc0204de4:	e0c2                	sd	a6,64(sp)
ffffffffc0204de6:	e4c6                	sd	a7,72(sp)
    va_start(ap, fmt);
ffffffffc0204de8:	e41a                	sd	t1,8(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc0204dea:	c89ff0ef          	jal	ra,ffffffffc0204a72 <vprintfmt>
}
ffffffffc0204dee:	60e2                	ld	ra,24(sp)
ffffffffc0204df0:	6161                	addi	sp,sp,80
ffffffffc0204df2:	8082                	ret

ffffffffc0204df4 <strlen>:
...
strlen(const char *s) {
    size_t cnt = 0;
    while (*s ++ != '\0') {
ffffffffc0204df4:	00054783          	lbu	a5,0(a0)
strlen(const char *s) {
ffffffffc0204df8:	872a                	mv	a4,a0
    size_t cnt = 0;
ffffffffc0204dfa:	4501                	li	a0,0
    while (*s ++ != '\0') {
ffffffffc0204dfc:	cb81                	beqz	a5,ffffffffc0204e0c <strlen+0x18>
        cnt ++;
ffffffffc0204dfe:	0505                	addi	a0,a0,1
    while (*s ++ != '\0') {
ffffffffc0204e00:	00a707b3          	add	a5,a4,a0
ffffffffc0204e04:	0007c783          	lbu	a5,0(a5)
ffffffffc0204e08:	fbfd                	bnez	a5,ffffffffc0204dfe <strlen+0xa>
...
strnlen(const char *s, size_t len) {
    size_t cnt = 0;
ffffffffc0204e0e:	4781                	li	a5,0
    while (cnt < len && *s ++ != '\0') {
ffffffffc0204e10:	e589                	bnez	a1,ffffffffc0204e1a <strnlen+0xc>
ffffffffc0204e12:	a811                	j	ffffffffc0204e26 <strnlen+0x18>
        cnt ++;
ffffffffc0204e14:	0785                	addi	a5,a5,1
    while (cnt < len && *s ++ != '\0') {
ffffffffc0204e16:	00f58863          	beq	a1,a5,ffffffffc0204e26 <strnlen+0x18>
ffffffffc0204e1a:	00f50733          	add	a4,a0,a5
ffffffffc0204e1e:	00074703          	lbu	a4,0(a4)
ffffffffc0204e22:	fb6d                	bnez	a4,ffffffffc0204e14 <strnlen+0x6>
ffffffffc0204e24:	85be                	mv	a1,a5
    }
    return cnt;
}
ffffffffc0204e26:	852e                	mv	a0,a1
...
ffffffffc0204e30:	0785                	addi	a5,a5,1
...
ffffffffc0204e40:	0005c703          	lbu	a4,0(a1)
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0204e44:	cb89                	beqz	a5,ffffffffc0204e56 <strcmp+0x1a>
        s1 ++, s2 ++;
ffffffffc0204e46:	0505                	addi	a0,a0,1
ffffffffc0204e48:	0585                	addi	a1,a1,1
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0204e4a:	fee789e3          	beq	a5,a4,ffffffffc0204e3c <strcmp>
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0204e4e:	0007851b          	sext.w	a0,a5
#endif /* __HAVE_ARCH_STRCMP */
}
ffffffffc0204e52:	9d19                	subw	a0,a0,a4
ffffffffc0204e54:	8082                	ret
ffffffffc0204e56:	4501                	li	a0,0
ffffffffc0204e58:	bfed                	j	ffffffffc0204e52 <strcmp+0x16>

ffffffffc0204e5a <strchr>:
...
ffffffffc0204e5e:	c799                	beqz	a5,ffffffffc0204e6c <strchr+0x12>
        if (*s == c) {
ffffffffc0204e60:	00f58763          	beq	a1,a5,ffffffffc0204e6e <strchr+0x14>
    while (*s != '\0') {
ffffffffc0204e64:	00154783          	lbu	a5,1(a0)
            return (char *)s;
        }
        s ++;
ffffffffc0204e68:	0505                	addi	a0,a0,1
    while (*s != '\0') {
ffffffffc0204e6a:	fbfd                	bnez	a5,ffffffffc0204e60 <strchr+0x6>
    }
    return NULL;
...
memset(void *s, char c, size_t n) {
    ...
    char *p = s;
    while (n -- > 0) {
ffffffffc0204e70:	ca01                	beqz	a2,ffffffffc0204e80 <memset+0x10>
ffffffffc0204e72:	962a                	add	a2,a2,a0
    char *p = s;
ffffffffc0204e74:	87aa                	mv	a5,a0
        *p ++ = c;
ffffffffc0204e76:	0785                	addi	a5,a5,1
ffffffffc0204e78:	feb78fa3          	sb	a1,-1(a5)
    while (n -- > 0) {
ffffffffc0204e7c:	fec79de3          	bne	a5,a2,ffffffffc0204e76 <memset+0x6>
    }
    return s;
...
ffffffffc0204e82 <memcpy>:
    ...
    char *d = dst;
    while (n -- > 0) {
ffffffffc0204e82:	ca19                	beqz	a2,ffffffffc0204e98 <memcpy+0x16>
ffffffffc0204e84:	962e                	add	a2,a2,a1
    char *d = dst;
ffffffffc0204e86:	87aa                	mv	a5,a0
        *d ++ = *s ++;
ffffffffc0204e88:	0005c703          	lbu	a4,0(a1)
ffffffffc0204e8c:	0585                	addi	a1,a1,1
ffffffffc0204e8e:	0785                	addi	a5,a5,1
ffffffffc0204e90:	fee78fa3          	sb	a4,-1(a5)
    while (n -- > 0) {
ffffffffc0204e94:	fec59ae3          	bne	a1,a2,ffffffffc0204e88 <memcpy+0x6>
    }
    return dst;
...
memcmp(const void *v1, const void *v2, size_t n) {
    ...
    while (n -- > 0) {
ffffffffc0204e9a:	c205                	beqz	a2,ffffffffc0204eba <memcmp+0x20>
ffffffffc0204e9c:	962e                	add	a2,a2,a1
ffffffffc0204e9e:	a019                	j	ffffffffc0204ea4 <memcmp+0xa>
ffffffffc0204ea0:	00c58d63          	beq	a1,a2,ffffffffc0204eba <memcmp+0x20>
        if (*s1 != *s2) {
...
ffffffffc0204ea8:	0005c703          	lbu	a4,0(a1)
        ...
        s1 ++, s2 ++;
ffffffffc0204eac:	0505                	addi	a0,a0,1
ffffffffc0204eae:	0585                	addi	a1,a1,1
        if (*s1 != *s2) {
ffffffffc0204eb0:	fee788e3          	beq	a5,a4,ffffffffc0204ea0 <memcmp+0x6>
            return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0204eb4:	40e7853b          	subw	a0,a5,a4
